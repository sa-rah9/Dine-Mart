...
export default function About() {
  return (
    ...
    <h1 className='text-white  text-6xl font-bold text-center pt-10 pb-10 md:text-6xl px-5'>Unique and Authentic Vintage Designer Jewellery</h1>
    ...
    < Image src={"/fashion3.jpg"} alt='image' width={300} height={300} className='object-cover 5 pt-5 pb-5'/>
    </div>
    ...
    <h1 className=' px-4 text-center text-xl font-semibold text-white'>USING GOOD QUALITY MATERIALS 100% HANDMADE PRODUCTS DISCOUNT FOR BULK ORDERS MODERN FASHION DESIGN
    </h1>
    <button className="mb-5 bg-[#22324D] border-2 border-solid px-8 py-2 text-white text-center ml-20 mt-4 ">
                See All Products
     </button>
    </div>
